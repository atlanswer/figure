export default () => (
  <main class="flex-auto">
    <article class="prose dark:prose-invert mx-auto max-w-screen-xl px-8 py-16 md:px-16">
      <h1>Figure</h1>
      ...
      <h2>Privacy</h2>
      <p>
        This web app does not collect, store, or share any private data. The
        only data it processes are files you choose to upload and your system
        theme. The latter is stored locally in your browser.
      </p>
      <p>
      ...
      <blockquote>
        ...
        <p>
          ...
          <b>3.5 inches / 88 millimeters / 21 picas</b>) or page wide (7.16
          inches / 181 millimeters / 43 picas). The maximum depth a graphic can
        ...
        <p>
          While IEEE does accept vector artwork, it is our policy is to
          rasterize all figures for publication. This is done in order to
          preserve the figures’ integrity across multiple computer platforms.
        </p>
        <p>
          All color figures should be generated in <b>RGB</b> or CMYK color
          space. Grayscale images should be submitted in Grayscale color space.
          Line art may be provided in grayscale OR bitmap colorspace.
        </p>
        <p>
        ...
        <footer>
          —
          <cite>
            Preparation of Papers for IEEE Transactions and Journals (April
            2013)
          </cite>
        </footer>
      </blockquote>
