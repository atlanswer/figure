export const Error = (err: { toString: () => string }, reset: () => void) => (
  <main class="grid flex-auto place-content-center">
    <div class="grid max-w-96 grid-flow-row place-content-center place-items-center gap-4 rounded bg-red-100 p-4 text-red-500 outline outline-red-500">
